...
import com.haiphamcoder.dataprocessing.shared.DataSourceUtils;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {
        "com.haiphamcoder.dataprocessing.repository.impl" }, entityManagerFactoryRef = "mainEntityManagerFactory", transactionManagerRef = "mainTransactionManager")
public class MainDataSourceConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return DataSourceUtils.createEntityManagerFactoryBean(
                ...
                mainDataSource,
                "main",
                "com.haiphamcoder.reporting.domain.entity");
    }
