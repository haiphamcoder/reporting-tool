...
import com.haiphamcoder.authentication.shared.DataSourceUtils;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {
        "com.haiphamcoder.authentication.repository.impl" }, entityManagerFactoryRef = "mainEntityManagerFactory", transactionManagerRef = "mainTransactionManager")
public class DataSourceConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return DataSourceUtils.createEntityManagerFactoryBean(
                ...
                mainDataSource,
                "main",
                "com.haiphamcoder.authentication.domain.entity");
    }
