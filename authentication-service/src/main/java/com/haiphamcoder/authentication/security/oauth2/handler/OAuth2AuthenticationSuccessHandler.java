...
import com.haiphamcoder.authentication.config.CommonConstants;
import com.haiphamcoder.authentication.config.OAuth2AuthorizedRedirectUriConfiguration;
...
import com.haiphamcoder.authentication.service.impl.CustomUserService;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        UserDto user = customUserDetailsService.getUserByEmail(email);
