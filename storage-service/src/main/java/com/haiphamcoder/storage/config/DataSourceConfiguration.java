...
import com.haiphamcoder.storage.shared.DataSourceUtils;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {
        "com.haiphamcoder.storage.repository.impl" }, entityManagerFactoryRef = "mainEntityManagerFactory", transactionManagerRef = "mainTransactionManager")
public class DataSourceConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return DataSourceUtils.createEntityManagerFactoryBean(
                ...
                mainDataSource,
                "main",
                "com.haiphamcoder.storage.domain.entity");
    }
