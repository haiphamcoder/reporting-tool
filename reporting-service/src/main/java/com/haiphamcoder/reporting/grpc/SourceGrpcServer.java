...
import com.haiphamcoder.reporting.service.impl.SourceServiceGrpcImpl;
...
public class SourceGrpcServer {
    ...
    public void start() throws IOException {
        server = ServerBuilder.forPort(port)
                .addService(sourceServiceGrpcImpl)
                .build()
                .start();
