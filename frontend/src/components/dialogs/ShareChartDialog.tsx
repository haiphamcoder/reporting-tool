...
export default function ShareChartDialog({
    open,
    onClose,
    chartId,
    chartName = 'Chart',
    onSuccess
}: ShareChartDialogProps) {
    ...
    const fetchSharedUsers = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_CONFIG.BASE_URL}/reporting/charts/${chartId}/share`, {
                method: 'GET',
                credentials: 'include',
                headers: {
                ...
                <Box>
                    ...
                    {loading ? (
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', py: 3 }}>
                            No users are currently shared with this chart
                        </Typography>
                    ) : (
                        <List>
