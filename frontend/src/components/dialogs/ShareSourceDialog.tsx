...
interface ShareSourceDialogProps {
    open: boolean;
    onClose: () => void;
    sourceId: string;
    sourceName?: string;
...
export default function ShareSourceDialog({
    open,
    onClose,
    sourceId,
    sourceName = 'Source',
    ...
    const fetchSharedUsers = useCallback(async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_CONFIG.BASE_URL}/reporting/sources/${sourceId}/share`, {
                method: 'GET',
                credentials: 'include',
                headers: {
                ...
                <Box>
                    ...
                    {loading ? (
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', py: 3 }}>
                            No users are currently shared with this source
                        </Typography>
                    ) : (
                        <List>
