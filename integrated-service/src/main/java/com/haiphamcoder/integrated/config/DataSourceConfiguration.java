...
import com.haiphamcoder.integrated.shared.DataSourceUtils;
import com.zaxxer.hikari.HikariDataSource;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {
        "com.haiphamcoder.integrated.repository.impl" }, entityManagerFactoryRef = "mainEntityManagerFactory", transactionManagerRef = "mainTransactionManager")
public class DataSourceConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return DataSourceUtils.createEntityManagerFactoryBean(
                ...
                mainDataSource,
                "main",
                "com.haiphamcoder.integrated.domain.entity");
    }
